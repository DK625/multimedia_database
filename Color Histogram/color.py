...
a=[len(os.listdir(os.path.join(dir,os.listdir(dir)[x]))) for x in range(0,5)]
# print(a)
sum(a)
...
#print(embedding)
# arr = np.array(data_RGB, dtype=object)
# Tên file CSV
# csv_file = 'color_features.csv'
